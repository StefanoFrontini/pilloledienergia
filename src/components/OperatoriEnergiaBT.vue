    ...
    <svg :width="svgWidth" :height="svgHeight">
      ...
      >
        ...
        <g
          ...
          :transform="`translate(12,${innerHeight + 10})`"
        ></g>
        <text
          :x="innerWidth / 2"
          :y="innerHeight + 85"
      ...
      <g :transform="`translate(0,${this.svgHeight - 22})`">
        ...
        <text
          ...
          style="font-size: 0.5em; fill: #1B1B1B;font-style: italic;font-family: radnika-medium;"
        >
          ARERA, Indagine annuale sui settori regolati
        </text>
      </g>
    </svg>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      dataYval: { fontsize: { low: 0.4, high: 0.7 } },
    };
  },
