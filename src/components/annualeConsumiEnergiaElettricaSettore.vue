    ...
    <svg :width="svgWidth" :height="svgHeight">
      ...
      >
        ...
        <g v-for="(item, i) in chartData" :key="i">
          <text
            :style="`font-size: ${textLabel}em; fill: #5B9BD5;`"
            :x="item.x"
            :y="item.y1 - 10"
          >
            {{ item.y1Value }}
          ...
          <text
            :style="
              `text-anchor: middle; font-size: ${textLabel}em; fill: #f78411;`
            "
            :x="item.x"
            :y="item.y2 - 7"
          >
          ...
          <text
            :style="
              `text-anchor: middle; font-size: ${textLabel}em; fill: #1b1b1b;`
            "
            :x="item.x"
            :y="item.y3 - 10"
          >
          ...
          <text
            :style="
              `text-anchor: middle; font-size: ${textLabel}em; fill: #FFC000;`
            "
            :x="item.x"
            :y="item.y4 + 15"
          >
      ...
      <g :transform="`translate(0,${this.svgHeight - 22})`">
        ...
        <text
          x="40"
          y="15"
          style="font-size: 0.5em; fill: #1B1B1B;font-family: radnika-medium;"
        >
          Terna
        </text>
      </g>
...
export default {
  name: "AnnualeConsumiEnergiaElettricaSettore",
  props: {
    title: String,
    xKey: String,
    y1Key: String,
