<template>
  <vue-glide :bullet="true" :perView="1" ref="pilloleId">
    <vue-glide-slide>
      <h3>
      ...
      <p>
        ...
        contratto di fornitura ti ha permesso di beneficiare di questa discesa?
      </p>
    </vue-glide-slide>

    <vue-glide-slide>
      <h3>Perchè ricevo sempre conguagli?</h3>
    ...
    <vue-glide-slide>
      ...
      <p>
        Una recente sentenza della Corte di Cassazione permette di recuperare le
        accise 2010-2011. Tu hai fatto domanda?
      </p>
    </vue-glide-slide>
    ...
    <vue-glide-slide>
      ...
      <p>
        Con i miei Clienti comunico a quattr’occhi o tramite cellulare/whatsapp.
      </p>
    </vue-glide-slide>
...
export default {
  ...
  data() {
    return {
      YouTube: { height: { low: 182, high: 590 } },
      deviceWidth: 180,
    };
  },
  methods: {
