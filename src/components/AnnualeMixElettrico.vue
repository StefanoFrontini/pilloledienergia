    ...
    <svg :width="svgWidth" :height="svgHeight">
      ...
      >
        ...
        <g v-for="(item, i) in chartData" :key="i">
          ...
          <text
            style="text-anchor: middle; font-size: 0.45em; fill: black;font-family: radnika-medium;"
            :x="item.x"
            :y="item.y3 - 3"
          >
            {{ item.y3Value }}
          ...
          <text
            style="text-anchor: middle; font-size: 0.45em; fill: #FFC000;font-family: radnika-medium;"
            :x="item.x"
            :y="item.y4 - 9"
          >
            {{ item.y4Value }}
