    ...
    <svg :width="svgWidth" :height="svgHeight">
      ...
      >
        ...
        <g v-for="(item, i) in chartData" :key="i">
          <text
            :style="
              `font-size: ${textLabel}em; fill: #5B9BD5;font-family: radnika-medium;`
            "
            :x="item.x"
            :y="item.y1 - 10"
          >
          ...
          <text
            :style="
              `text-anchor: middle; font-size: ${textLabel}em; fill: #1b1b1b;font-family: radnika-medium;`
            "
            :x="item.x"
            :y="item.y3 - 10"
          >
          ...
          <text
            :style="
              `text-anchor: middle; font-size: ${textLabel}em; fill: #FFC000;font-family: radnika-medium;`
            "
            :x="item.x"
            :y="item.y4 - 5"
          >
      ...
      <g :transform="`translate(0,${this.svgHeight - 22})`">
        ...
        <text x="40" y="15" style="font-size: 0.5em; fill: #1B1B1B;">
          Ministero dello Sviluppo Economico. Consumi netto perdite
        </text>
      </g>
    </svg>
  </div>
