  ...
  <Layout>
    <div class="page-auto-elettriche">
      ...
      <div class="chart-container">
        <div class="chart">
          <AutoElettriche
            title="Immatricolazioni auto elettriche per marca e modello: maggio 2022"
            xKey="Modello"
            yKey="Immatricolazioni"
            :data="AutoElettricheData"
          />
          <CumulatoAutoElettriche
            title="Immatricolazioni auto elettriche per marca e modello: gennaio - maggio 2022"
            xKey="Modello"
            yKey="Immatricolazioni"
          ...
          <ul>
            <li>
              ...
              maggio 2022 distinte per marca e modello;
            </li>
            <li>
