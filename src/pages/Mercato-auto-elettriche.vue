  ...
  <Layout>
    <div class="page-auto-elettriche">
      ...
      <div class="chart-container">
        <div class="chart">
          <AutoElettriche
            title="Immatricolazioni auto elettriche per marca e modello: aprile 2021"
            xKey="Modello"
            yKey="Immatricolazioni"
            :data="AutoElettricheData"
          />
          <CumulatoAutoElettriche
            title="Immatricolazioni auto elettriche per marca e modello: gennaio - aprile 2021"
            xKey="Modello"
            yKey="Immatricolazioni"
          ...
          <ul>
            <li>
              ...
              aprile 2021 distinte per marca e modello;
            </li>
            <li>
